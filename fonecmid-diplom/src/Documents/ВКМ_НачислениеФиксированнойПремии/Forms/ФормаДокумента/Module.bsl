...
Процедура НачисленияСотрудникПриИзменении(Элемент)
	...
	ДанныеСотрудника = ВКМ_ДанныеСотрудниковВызовСервера.ДанныеСотрудника(ТекущиеДанные.Сотрудник, Объект.Дата); 
	
	ТекущиеДанные.Категория = ДанныеСотрудника.Категория;
